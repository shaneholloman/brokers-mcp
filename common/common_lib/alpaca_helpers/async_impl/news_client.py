...
from alpaca.data import NewsRequest, NewsSet
from common_lib.alpaca_helpers.async_impl.async_rest import AsyncRestClient, BaseURL, RawData


class AsyncNewsClient(AsyncRestClient):
    """
    ...
    async def get_news(self, request_params: NewsRequest) -> Union[RawData, NewsSet]:
        ...
        raw_news = await self._get_marketdata(
            path=f"/news",
