...
class AsyncStockHistoricalDataClient(AsyncRestClient):
    def __init__(
        self,
    ...
    async def get_stock_bars(
        ...
        """
        raw_bars = await self._get_marketdata(
            path="/stocks/bars",
    ...
    async def get_stock_quotes(
        ...
        """
        raw_quotes = await self._get_marketdata(
            path="/stocks/quotes",
            params=request_params.to_request_fields(),
        )
    ...
    async def get_stock_trades(
        ...
        """
        raw_trades = await self._get_marketdata(
            path="/stocks/trades",
            params=request_params.to_request_fields(),
        )
    ...
    async def get_stock_latest_trade(
        ...
        """
        raw_latest_trades = await self._get_marketdata(
    ...
    async def get_stock_latest_quote(
        ...
        """
        raw_latest_quotes = await self._get_marketdata(
    ...
    async def get_stock_latest_bar(
        ...
        """
        raw_latest_bars = await self._get_marketdata(
    ...
    async def get_stock_snapshot(
        ...
        """
        raw_snapshots = await self._get_marketdata(
